...
public class TestCase_1 {
	public static void main(String[] args) throws IOException, InterruptedException, AWTException  {
		...
		FileInputStream fis = new FileInputStream("./src/test/java/Assessment/Day_8/commondata.properties");
		...
		//excelfile
		FileInputStream fis1 = new FileInputStream("./src/test/java/Assessment/Day_8/day8.xlsx");
